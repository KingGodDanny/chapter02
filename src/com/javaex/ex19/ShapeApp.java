...
public class ShapeApp {
	...
	public static void main(String[] args) {
		...
		//area();처럼 abstract포함해서 return값이 없는 메소드를
		//써주면 부모의것들을 메모리에 올릴수없음-----
		
		//1.  Shape ss01 = new Shape("블랙", "블랙");  (X)
		//2.  섞어쓰기했을떄는 오버라이딩 되도록한다. 
		//		-->메소드 제목만 만들어준다.
		//      -->abstract 를 이용해서 추상 메소드를 만든다.
		//			-->area();처럼 제목만 있기떄문에 자식들만 오버라이딩가능하다
		//			-->반드시 자식은 area();처럼 같은 이름의 메소드를 만들어야한다.
		//3.  추상메소드 1개라도 있는 클래스는 메모리에 인스턴스화하면 오류가 발생한다.
